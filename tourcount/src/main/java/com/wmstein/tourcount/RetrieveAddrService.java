...
/*****************************************************************************************************
 * IntentService to get, parse and store address info from Nominatim Reverse Geocoder of OpenStreetMap
 <p>
 * Copyright 2018-2023 wmstein
 * created on 2018-03-10,
 * last modification on 2023-05-24
 */
public class RetrieveAddrService extends IntentService // deprecated in API 30, Todo
{
    public RetrieveAddrService()
    {
        super("RetrieveAddrService");
    }

    @Override
    protected void onHandleIntent(Intent intent) // deprecated in API 30, Todo
    {
        String xmlString;
        URL url;
