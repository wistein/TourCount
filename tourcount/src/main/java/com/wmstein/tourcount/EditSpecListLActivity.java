 ...
 * EditSpecListLActivity is called from CountingLActivity
 * Uses CountEditWidget.java, activity_edit_section.xml, widget_edit_count.xml.
 * Calls AddSpeciesLActivity.java for adding a new species to the species list.
 <p>
...
public class EditSpecListLActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener, PermissionsDialogFragment.PermissionsGrantedCallback
{
    ...
    private boolean saveData()
    {
        ...
        if (retValue)
        {
            ...
            Toast.makeText(EditSpecListLActivity.this, getString(R.string.sectSaving) + " " + section.name + "!", Toast.LENGTH_SHORT).show();
        }
    ...
    public void newCount(View view)
    {
        ...
        {
            Intent intent = new Intent(EditSpecListLActivity.this, AddSpeciesLActivity.class);
